...
def process_user_input(machine_ids, model, index, sentences, send_prompt, questions):
    ...
    role_contexts = {
        "ceo": "",
        "cto": (
            "CTO: Develop and execute a comprehensive technology strategy tailored to the company's business "
            "objectives, scalability, and operational efficiency. Create and manage the technology budget, optimize resource "
            "allocation, and ensure cost-effective solutions. Oversee the design and implementation of robust technical architectures, "
            "ensuring alignment with business requirements, security standards and industry’s best practices. Establish and maintain "
            "efficient and reliable technology operations, including systems infrastructure, network, data management and security protocols "
            "for high performance, uptime, and data integrity. Develop and implement disaster recovery plans and business continuity strategies. "
            "Identify and mitigate technology-related risks, ensuring data privacy and security regulations compliance. Stay aware of the latest tech "
            "advancements to provide strategic insights and recommendations for maintaining our technological edge."
        ),
        "vp information technology": (
            "VP of IT: Collaborate with IT and business leadership to determine annual and ongoing IT project portfolio and priorities. "
            "Participate in technology needs discovery, project planning, and scope definition with internal business units and third-party vendors. "
            "Develop, monitor, and adapt project plans; identify and mitigate risks to deadlines, milestones, deliverables, and budgets. Aid in the development "
            "of project-related documentation including business requirements and technical specifications. Ensure projects and systems follow company policies, "
            "procedures, and legal/regulatory requirements. Become familiar with various applications across the organization and, over time, become a subject matter expert. "
            "Assist with IT Steering Committee planning and overall enterprise architecture. Support the development of key metrics to monitor IT performance."
        ),
        "it director": (
            "IT Director/Director of IT: Lead and design the global IT strategy and ensure the technology roadmap for the next 5 years is aligned "
            "across all geographies and supports business outcomes. Develop and implement a strategic vision for applications development, collaborating with senior management "
            "to prioritize initiatives. Provide technical leadership to application development teams. Understand SAP and S/4HANA architectures, and work with technical teams "
            "to assess requirements, perform data migration, and configure enterprise applications. Lead initiatives to enhance operational efficiency and optimize resource allocation. "
            "Manage a global IT team and foster strategic relationships with key suppliers."
        ),
        "sw manager": (
            "Software Manager: Develop your team according to a people management plan by hiring talented team members and nurturing their skills. Empower team members through delegation, "
            "identify and ensure the necessary tools and technologies are in place, and collaborate closely with peers and the Chief Architect to understand business processes. "
            "Analyze and resolve technical problems, improve processes, and document improvements. Develop code-managed infrastructure, write tests for monitoring, implement customer-facing features, "
            "and build CI/CD pipelines while adhering to best practices for performance optimization and scalability."
        ),
        "it administrator": (
            "IT Administrator: Provide desktop support to employees by troubleshooting hardware and software issues, onboard new employees by setting up accounts and equipment, "
            "and manage hardware/software procurement. Maintain the Azure environment, Active Directory, DNS, and DHCP infrastructures, and administer Office 365 along with other key IT systems. "
            "Handle administration tasks for platforms such as Mimecast, Incontact, Adobe, Smartsheet, Citrix, JIRA, and Insight Web Portal. Manage endpoint security solutions including Cisco AMP, "
            "DUO Multi Factor Authentication, and MDM Airwatch, as well as incident response systems like PagerDuty."
        )
    }
    ...
    while True:
        ...
        prompt = f"""{role_context}
                Above is the context for the user and their specific role. When giving responses, consider this context and vary output appropriately—take into account what information the role would want to hear.
